...
# Creates a sequence from 0 to 8.
time_yr <- seq(from = 0, to = 8, by = 1)

# Creates a matrices based on the size of fish_year0 (col) and time_yr (row)
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# This line puts fish_year0 as the first row of the matrices.
proj_year[1, ] <- fish_year0

# This loop populates each row of proj_year with the dot product of fish_leslie dot the previous proj_year. 
# Starts at year 2.
